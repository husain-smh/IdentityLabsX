            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-4 py-3 border border-stone-200 rounded-xl 
            ...
            <div className="bg-stone-50 rounded-xl p-4 border border-stone-100">
              <div className="flex items-center gap-3">
                <div className="flex-1 overflow-hidden">
                  <p className="text-xs text-stone-500 mb-1">Auth Link:</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-stone-200 overflow-hidden">
          <div className="p-6 border-b border-stone-100 flex items-center justify-between">
            ...
            <button
              ...
              disabled={isLoading}
              className="p-2 text-stone-500 hover:text-stone-700 hover:bg-stone-100 
          ...
          {isLoading && clients.length === 0 && (
            <div className="p-12 text-center">
              <div className="animate-spin h-8 w-8 border-4 border-stone-200 border-t-stone-800 rounded-full mx-auto mb-4"></div>
              <p className="text-stone-500">Loading clients...</p>
            </div>
          )}
          ...
          {!isLoading && clients.length === 0 && !error && (
            <div className="p-12 text-center">
              ...
              <h3 className="text-stone-800 font-medium mb-1">No clients yet</h3>
                    ...
                    <tr key={client.client_id} className="hover:bg-stone-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-medium text-stone-800">@{client.x_username}</p>
                            <p className="text-sm text-stone-500">{client.x_name}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
